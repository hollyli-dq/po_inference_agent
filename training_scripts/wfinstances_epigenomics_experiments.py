...
from src.utils.result_paths import WFINSTANCES_EPIGENOMICS_RESULTS_DIR
...
OUTPUT_DIR = WFINSTANCES_EPIGENOMICS_RESULTS_DIR
...
# This can improve results when the reversible jump doesn't mix well
USE_FIXED_K = True
...
def run_single_experiment(
    ...
    scenario_id = f"epigenomics_ip{ip_cov_target}"
    if PM4PY_AVAILABLE:
        try:
...
def main():
    ...
    parser.add_argument(
        ...
        help="Use fixed K=n/2 instead of reversible jump MCMC (default: True)"
    )
    parser.add_argument(
