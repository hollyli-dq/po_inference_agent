...
from src.utils.cloud_iac_coverage import CloudIacObservedCriticalPairCoverageAnalyzer


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Analyze observed Cloud-IaC IP-Cov over traces.")
    parser.add_argument(
        "--trace-source",
...
def main() -> None:
    ...
    analyzer = CloudIacObservedCriticalPairCoverageAnalyzer(
