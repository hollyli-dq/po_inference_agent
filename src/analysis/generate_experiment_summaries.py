...
# Try to load scenario data from the Cloud-IaC dataset if it exists
scenario_metadata = {}
try:
    cloud_iac_data_dir = resolve_cloud_iac_data_root(PROJECT_ROOT)
    scenario_dir = resolve_cloud_iac_ground_truth_dir(cloud_iac_data_dir)
    print(f"Loading scenario data from {scenario_dir}...")
    ...
    print("Note: Cloud-IaC dataset not found. Will use generic task IDs.")
