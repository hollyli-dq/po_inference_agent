...
Usage:
    python analyze_wfinstances_results.py --experiment srasearch
    python analyze_wfinstances_results.py --experiment epigenomics
"""
...
def load_experiment_results(experiment: str) -> Dict[str, Any]:
    ...
    if experiment == 'srasearch':
        base_dir = PROJECT_ROOT / 'notebooks' / 'wfinstances_srasearch_results'
        data_dir = PROJECT_ROOT / 'data' / 'wfinstances_srasearch'
    elif experiment == 'epigenomics':
        base_dir = PROJECT_ROOT / 'notebooks' / 'wfinstances_epigenomics_results'
